...
func (m *MockClient) GetDHCPLeasesByNetwork(networkName string) ([]libvirt.NetworkDHCPLease, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) LookupDomainByName(name string) (*libvirt.Domain, error) {
	m.ctrl.T.Helper()
